...
- (void)viewDidLoad {
	...
	self.outgoingBubbleImageView = [JSQMessagesBubbleImageFactory
	                                taillessMessageBubbleImageViewWithColor:[UIColor jsq_messageBubbleLightGrayColor]];

	self.incomingBubbleImageView = [JSQMessagesBubbleImageFactory
	                                taillessMessageBubbleImageViewWithColor:[UIColor jsq_messageBubbleGreenColor]];
