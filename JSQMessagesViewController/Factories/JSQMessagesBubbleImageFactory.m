...
+ (UIImageView *)taillessMessageBubbleImageViewWithColor:(UIColor *)color {
	NSParameterAssert(color != nil);
	return [JSQMessagesBubbleImageFactory tailessBubbleImageViewWithColor:color flippedForIncoming:NO];
}

#pragma mark - Private
+ (UIImageView *)tailessBubbleImageViewWithColor:(UIColor *)color flippedForIncoming:(BOOL)flippedForIncoming {
	return [JSQMessagesBubbleImageFactory createBubbleImageView:@"bubble_min_tailless" withColor:color flippedForIncoming:flippedForIncoming];
}

+ (UIImageView *)createBubbleImageView:(NSString *)bubbleImagePath withColor:(UIColor *)color flippedForIncoming:(BOOL)flippedForIncoming {
	UIImage *bubble = [UIImage imageNamed:bubbleImagePath];
...
+ (UIImageView *)bubbleImageViewWithColor:(UIColor *)color flippedForIncoming:(BOOL)flippedForIncoming {
	return [JSQMessagesBubbleImageFactory createBubbleImageView:@"bubble_min" withColor:color flippedForIncoming:flippedForIncoming];
}
